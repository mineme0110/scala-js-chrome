...
import chrome.OptionPickler.{readwriter, writeJs}
import chrome.{AppManifest, ExtensionManifest, Manifest, OptionPickler}
import OptionPickler.{ReadWriter => RW}
object JsonCodecs {

  implicit val rw: RW[Manifest] = {
    readwriter[ujson.Value].bimap[Manifest]({
