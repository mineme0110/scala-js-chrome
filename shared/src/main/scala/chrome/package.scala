...
package object chrome{
  object OptionPickler extends upickle.AttributeTagged {
    ...
    implicit def rwStrMap[T: ReadWriter]: ReadWriter[Map[String, T]] = readwriter[ujson.Obj].bimap[Map[String, T]](
      obj => {
    ...
    implicit def rwIntMap[T: ReadWriter]: ReadWriter[Map[Int, T]] = readwriter[ujson.Obj].bimap[Map[Int, T]](
      obj => {
